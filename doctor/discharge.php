    ...
    <div class="container-fluid">
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-10">
                    <h5 class="text-center my-2" style="color: white;">Check Patient Appointment</h5>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="card " style="background-color:#6cd5eb">
                                    ...
                                    <div class="card-body">
                                        ...
                                        if (isset($_POST['send'])) {
                                            ...
                                            if (empty($fee)) {
                                                echo "<p class='text-danger'>Please enter the fee.</p>";
                                            } else if (empty($des)) {
                                        ...
                                        <form method="post">
                                            ...
                                            <input type="submit" name="send" class="btn btn-success btn-block my-1"
                                                value="Send">
                                        </form>
                                    </div>
                                </div>
